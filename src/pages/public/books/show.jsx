                            ...
                            <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                                ...
                                >
                                    <div>
                                        <label
                                            htmlFor="quantity"
                                            className="block text-sm font-medium text-grey-700 dark:text-white"
                                        >
                                            Jumlah
                                        </label>
                                        <input
                                            ...
                                            className="mt-1 block w-24 px-3 py-2 border-grey-300 rounded-md shadow-sm dark:bg-grey-800 dark:border-grey-600 dark:text-grey-300 focus:outline-none focus:border-indigo-500 sm:text-sm"
                                        />
                                    </div>
